<template>
  <nav class="navbar navbar-expand-lg navbar-light bg-light shadow bg-body rounded">
    <div class="container-fluid">
      ...
      <ul class="navbar-nav" style="margin-right: 100px" v-if="$store.state.user.is_login">
      ...
      <ul class="navbar-nav" style="margin-right: 100px" v-else-if="!$store.state.user.pulling_info">
        <li class="nav-item">
